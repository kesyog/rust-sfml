...
unsafe extern "C" {
    ...
    pub fn sfCustomSoundRecorder_new(
        onStart: sfCustomSoundRecorderStartCb,
        onProcess: sfCustomSoundRecorderProcessCb,
        onStop: sfCustomSoundRecorderStopCb,
        userData: *mut c_void,
    ) -> *mut sfCustomSoundRecorder;
    pub fn sfCustomSoundRecorder_del(soundRecorder: *mut sfCustomSoundRecorder);
    pub fn sfCustomSoundRecorder_start(
        soundRecorder: *mut sfCustomSoundRecorder,
        sampleRate: c_uint,
    ) -> bool;
    pub fn sfCustomSoundRecorder_stop(soundRecorder: *mut sfCustomSoundRecorder);
    pub fn sfCustomSoundRecorder_getSampleRate(
        soundRecorder: *const sfCustomSoundRecorder,
    ) -> c_uint;
    pub fn sfCustomSoundRecorder_setProcessingInterval(
        soundRecorder: *mut sfCustomSoundRecorder,
        interval: i64,
    );
    pub fn sfCustomSoundRecorder_setDevice(
        soundRecorder: *mut sfCustomSoundRecorder,
        name: *const c_char,
    ) -> bool;
    pub fn sfCustomSoundRecorder_getDevice(
        soundRecorder: *mut sfCustomSoundRecorder,
    ) -> *const sfStdString;
    pub fn sfCustomSoundRecorder_setChannelCount(
        soundRecorder: *mut sfCustomSoundRecorder,
        channelCount: c_uint,
    );
    pub fn sfCustomSoundRecorder_getChannelCount(
        soundRecorder: *const sfCustomSoundRecorder,
    ) -> c_uint;
    // CustomSoundStream.cpp
    pub fn sfCustomSoundStream_new(
        onGetData: sfCustomSoundStreamGetDataCb,
        onSeek: sfCustomSoundStreamSeekCb,
        channelCount: c_uint,
        sampleRate: c_uint,
        userData: *mut c_void,
    ) -> *mut sfCustomSoundStream;
    ...
    pub fn sfCustomSoundStream_getStatus(
        soundStream: *const sfCustomSoundStream,
    ) -> sfSoundStreamStatus;
    ...
    pub fn sfCustomSoundStream_setPosition(
        soundStream: *mut sfCustomSoundStream,
        position: sfVector3f,
    );
    pub fn sfCustomSoundStream_setRelativeToListener(
        soundStream: *mut sfCustomSoundStream,
        relative: bool,
    );
    pub fn sfCustomSoundStream_setMinDistance(soundStream: *mut sfCustomSoundStream, distance: f32);
    pub fn sfCustomSoundStream_setAttenuation(
        soundStream: *mut sfCustomSoundStream,
        attenuation: f32,
    );
    pub fn sfCustomSoundStream_setPlayingOffset(
        soundStream: *mut sfCustomSoundStream,
        timeOffset: i64,
    );
    ...
    pub fn sfCustomSoundStream_isRelativeToListener(
        soundStream: *const sfCustomSoundStream,
    ) -> bool;
    ...
    pub fn sfMusic_openFromMemory(music: *mut sfMusic, data: *const u8, sizeInBytes: usize)
        -> bool;
    ...
    pub fn sfSoundBuffer_loadFromMemory(
        buffer: *mut sfSoundBuffer,
        data: *const u8,
        sizeInBytes: usize,
    ) -> bool;
    pub fn sfSoundBuffer_loadFromStream(
        buffer: *mut sfSoundBuffer,
        stream: *mut sfInputStreamHelper,
    ) -> bool;
    pub fn sfSoundBuffer_loadFromSamples(
        buffer: *mut sfSoundBuffer,
        samples: *const i16,
        sampleCount: u64,
        channelCount: c_uint,
