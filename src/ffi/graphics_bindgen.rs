...
unsafe extern "C" {
    ...
    // CustomShape.cpp
    pub fn sfCustomShape_new(
        getPointCount: sfCustomShapeGetPointCountCb,
        getPoint: sfCustomShapeGetPointCb,
        userData: *mut c_void,
    ) -> *mut sfCustomShape;
    ...
    pub fn sfCustomShape_setTexture(
        shape: *mut sfCustomShape,
        texture: *const sfTexture,
        resetRect: bool,
    );
    ...
    // Font.cpp
    pub fn sfFont_create() -> *mut sfFont;
    ...
    pub fn sfImage_create_w_h_color(
        image: *mut sfImage,
        width: c_uint,
        height: c_uint,
        color: sfColor,
    );
    pub fn sfImage_create_w_h_pixels(
        image: *mut sfImage,
        width: c_uint,
        height: c_uint,
        data: *const u8,
    ...
    pub fn sfImage_loadFromMemory(image: *mut sfImage, data: *const u8, sizeInBytes: usize)
        -> bool;
    ...
    pub fn sfShader_loadFromStream_vert_frag(
        shader: *mut sfShader,
        vert: *mut sfInputStreamHelper,
        frag: *mut sfInputStreamHelper,
    ) -> bool;
